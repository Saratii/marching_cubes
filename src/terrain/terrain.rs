...
#[derive(Resource)]
pub struct DirtTextureHandle(pub Handle<Image>);
...
pub fn setup_map(
    ...
    let dirt_texture_handle: Handle<Image> = asset_server
        .load_with_settings::<Image, ImageLoaderSettings>("Dirt_01.png", |settings| {
    ...
    commands.insert_resource(DirtTextureHandle(dirt_texture_handle));
}
