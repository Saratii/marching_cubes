...
pub const REDUCED_LOD_1_RADIUS: f32 = 80.0; //red
pub const REDUCED_LOD_2_RADIUS: f32 = REDUCED_LOD_1_RADIUS * 2.0; //cyan
pub const REDUCED_LOD_3_RADIUS: f32 = REDUCED_LOD_1_RADIUS * 4.0; //blue
pub const REDUCED_LOD_4_RADIUS: f32 = REDUCED_LOD_1_RADIUS * 8.0; //yellow
pub const REDUCED_LOD_5_RADIUS: f32 = REDUCED_LOD_1_RADIUS * 16.0; //purple
...
pub const SAMPLES_PER_CHUNK_DIM_PADDED: usize = SAMPLES_PER_CHUNK_DIM + 2;
...
pub const SAMPLES_PER_CHUNK_PADDED: usize = (SAMPLES_PER_CHUNK_DIM + 2).pow(3);
pub const SAMPLES_PER_CHUNK_2D: usize = SAMPLES_PER_CHUNK_DIM.pow(2);
pub const SAMPLES_PER_CHUNK_2D_PADDED: usize = SAMPLES_PER_CHUNK_DIM_PADDED.pow(2);
